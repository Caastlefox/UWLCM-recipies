...
#PJM -L "node=4"              # Number of nodes (1D)
#PJM -L "rscgrp=small"         # Specify resource group
#PJM -L "elapse=10:00:00"         # Job run time limit value
...
#PJM -j
##PJM -e /vol0006/mdt1/home/u14261/run_scripts/spack/moist_thermal/outerr/mt_lgrngn_%j.err
##PJM --working-dir "/vol0001/hp250099/u14261/output"
#PJM -D /vol0001/hp250099/u14261/output/moist_thermal_lgrngn
#PJM -o /vol0001/hp250099/u14261/output/moist_thermal_lgrngn/%j.out
...
echo "NX=$NX, NY=$NY, X=$X, Y=$Y, SD_CONC=$SD_CONC"

mpiexec /vol0001/hp250099/u14261/builds_with_spack_mpi/bin/uwlcm \
        --outdir=${outdir}  --case=moist_thermal --nx=${NX} --ny=${NY} --nz=96 --dt=0.5 \
        --spinup=0 --nt=12 --micro=lgrngn --sd_conc=${SD_CONC} --backend=OpenMP --outfreq=12 \
        --sstp_cond=5 --sstp_coal=5 --coal=1 --sgs=1 --window=0 \
        --coal_kernel=hall --term_vel=beard76 --save_vel=0 --X=${X} --Y=${Y} || true # lgrngn micro with mpi gives an error on exit, ignore it 
