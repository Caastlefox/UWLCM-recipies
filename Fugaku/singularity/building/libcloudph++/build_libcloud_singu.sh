...
rm -rf /home/u14261/code/libcloudphxx/build/
mkdir /home/u14261/code/libcloudphxx/build/
...
singularity exec ~/singu_images/uwlcm_ubuntu_24_04_cuda_12_9_0_arm64.sif sh -c "cd ~/code/libcloudphxx/build; cmake .. -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_COMPILER=g++ -DCMAKE_INSTALL_PREFIX=$HOME/builds_with_gcc -DLIBCLOUDPHXX_DISABLE_CUDA=True; make -j4 install"
